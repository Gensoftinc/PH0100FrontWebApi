<div class="header">
			<div class="header-top">
				<div class="container">
					...
					<div class="top-right">
					<ul>
						<li><a href="${pageContext.request.contextPath}/showCartProductsOfUser">Checkout</a></li>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												...
												<div class="col-sm-3  multi-gd-img">
														<a href="products.html"><img src="${pageContext.request.contextPath}/resources/images/woo.jpg" alt=" "/></a>
												</div> 
												<div class="col-sm-3  multi-gd-img">
														<a href="products.html"><img src="${pageContext.request.contextPath}/resources/images/woo1.jpg" alt=" "/></a>
												</div>
												<div class="clearfix"></div>
											</div>
										</ul>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												...
												<div class="col-sm-3  multi-gd-img">
														<a href="products1.html"><img src="${pageContext.request.contextPath}/resources/images/woo3.jpg" alt=" "/></a>
												</div> 
												<div class="col-sm-3  multi-gd-img">
														<a href="products1.html"><img src="${pageContext.request.contextPath}/resources/images/woo4.jpg" alt=" "/></a>
												</div>
												<div class="clearfix"></div>
											</div>
										</ul>
